...
::: {.callout-caution title="Avant de commencer"}
- Nous n'allons maintenant plus coder dans des Notebooks mais dans l'IDE VSCode
- Suivez les consignes données dans le fichier de [paramétrage et d'utilisation de VSCode](../outils/VSCode.qmd)
...
[Diagrammes de classe avec Mermaid](https://mermaid.js.org/syntax/classDiagram.html){target="_blank"}
