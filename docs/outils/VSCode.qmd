...
[Visual Studio Code](https://code.visualstudio.com/){target="_blank"} est un logiciel qui permet d'éditer du code dans de très nombreux langages. Il propose également de nombreuses extensions pour faciliter le travail des développeurs.
