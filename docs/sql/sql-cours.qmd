...
Il existe de très nombreux type de données que l'on peut stocker, les principaux :
...
Pour plus d'informations, consultez la [documentation PostgreSQL](https://www.postgresql.org/docs/current/datatype.html){target="_blank"}.


### Types de données - Exemple {.smaller}
